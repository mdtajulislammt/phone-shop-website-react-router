...
const FavoritesCard = ({phone}) => {
     ...
     return (
          <div>
      <div className="relative flex max-w-[40rem] lg:h-[280px] border border-green-400 p-7 flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg shadow-green-300">
  ...
  <div className="p-6">
    ...
    <a className="inline-block" href="#">
      <button
        className="flex select-none items-center gap-2 rounded-lg py-3 px-6 text-center align-middle mt-2 font-sans text-xs font-bold uppercase text-white hover:text-black transition-all bg-green-500 hover:bg-green-400 active:bg-pink-500/30 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        type="button"
      >
        Purchase
        <svg
